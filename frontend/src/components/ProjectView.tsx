...
import { ArrowLeft, Plus, FileText, CheckCircle, Clock, AlertTriangle, Edit3, Trash2 } from 'lucide-react';
import { api } from '../api';
          ...
          chapters.map((chap, idx) => (
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <button className="btn-ghost" style={{ padding: '0.5rem', color: 'var(--text-secondary)' }} title="Edit Text">
                  <Edit3 size={18} />
                </button>
